"""
Test factice : on monkey-patch run_detection pour éviter d’exécuter YOLO en CI.
"""
import json
import types
...
def fake_run_detection(source: str, output: str | Path) -> None:
    data = [
...
def test_detection_monkeypatch(tmp_path) -> None:
    ...
    detect.run_detection = types.FunctionType(  # type: ignore
